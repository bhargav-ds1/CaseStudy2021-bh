...
class LSTMED(Algorithm, PyTorchUtils):
    def __init__(self, name: str = 'LSTM-ED', num_epochs: int = 40, batch_size: int = 2, lr: float = 1e-3,
                 hidden_size: int = 50, sequence_length: int = 30, train_gaussian_percentage: float = 0.10,
